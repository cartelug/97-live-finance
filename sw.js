...
const CACHE = "ns97-live-v31";
const ASSETS = ["./", "./index.html", "./sync.js?v=16", "./experience-v2.js?v=5", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/favicon.svg", "./icons/mark-97.png", "./icons/brand/mtn.jpg", "./icons/brand/airtel.png", "./icons/brand/equity.png"];
