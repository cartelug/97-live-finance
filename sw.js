...
const CACHE = "ns97-live-v22";
const ASSETS = ["./", "./index.html", "./sync.js?v=13", "./experience-v2.js", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/favicon.svg", "./icons/mark-97.png", "./icons/brand/mtn.jpg", "./icons/brand/airtel.png", "./icons/brand/equity.png"];
