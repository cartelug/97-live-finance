...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      ".s97-cloud-brand{font-family:'Audiowide','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:26px;font-weight:400;margin:0}.s97-cloud-sub{color:#B7BCA6;font-size:13px;line-height:1.55;margin:7px 0 18px}",
